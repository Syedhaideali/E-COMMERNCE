...
const title = (
    <h2 className='title'>Join On Day Long Fre Workshop for <b>Advance  <span>Mastering</span></b> on sales</h2>
)
  ...
  return (
    <section className='register-section padding-tb pb-0'>
        <div className='container'>
            <div className='row g-4 row-cols-lg-2  row-cols-lg-1 aglin-items-center' >
                <div className='col'>
